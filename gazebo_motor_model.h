...
class GazeboMotorModel : public MotorModel, public ModelPlugin {
 ...
 private:
  ...
  std::string tilt_sub_topic_;   //editado
  ...
  double ref_tilt_rot_vel_;  //editado
  ...
  transport::SubscriberPtr command_tilt_sub_;  //editado
  ...
  void Velocity1Callback(CommandMotorSpeedPtr &rot1_velocities);  //editado
  ...
  std::unique_ptr<FirstOrderFilter<double>>  rotor_tilt_filter_;  //editado
/*
  // Protobuf test
